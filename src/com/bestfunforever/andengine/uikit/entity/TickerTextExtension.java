...
public class TickerTextExtension extends Text {
	...
	public TickerTextExtension(final float pX, final float pY, final IFont pFont, final String pText, final TickerTextOptions pTickerTextOptions, final VertexBufferObjectManager pVertexBufferObjectManager) {
	...
	public TickerTextExtension(final float pX, final float pY, final IFont pFont, final String pText,int maxText, final TickerTextOptions pTickerTextOptions, final VertexBufferObjectManager pVertexBufferObjectManager) {
		super(pX, pY, pFont, pText, maxText,pTickerTextOptions, pVertexBufferObjectManager);
