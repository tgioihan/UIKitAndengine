...
public abstract class BaseFacebookAcivity extends SimpleBaseGameActivity {
	 ...
	 * @param pictureLink
	 */
	public void shareFacebookWithDialog(String name,String caption,String description,   String link,
			String pictureLink) {
	 ...
	 */
	public void loginFacebook(final String[] readPermissions,
			final String[] publishPermissions,
							...
							openPublishPermission(true, new StatusCallback() {
								...
								public void call(Session session,
									...
									if (session.isOpened()) {
										...
										onLoginFacebookSuccess
												.onLoginFacebookFail(session,
														state, exception);
									}
								}
							}, Arrays.asList(publishPermissions));
						} else {
							onLoginFacebookSuccess.onLoginFacebookFail(session,
									state, exception);
						}
					} else if (session.isClosed()) {
						onLoginFacebookSuccess.onLoginFacebookFail(session,
	 ...
	 * @return
	 */
	private Session openPublishPermission(boolean allowLoginUI,
			final StatusCallback callback, final List<String> permissions) {
		OpenRequest openRequest = new OpenRequest(this).setPermissions(
	 ...
	 * @return
	 */
	private Session openReadPermission(boolean allowLoginUI,
